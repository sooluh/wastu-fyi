...
<div class="w-full overflow-hidden rounded-lg bg-white shadow-md">
  ...
  <div class="space-y-4 border-y border-gray-200 p-6">
    ...
    <div class="flex justify-center pt-2">
      <a
        href="/login/google"
        class="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
      >
